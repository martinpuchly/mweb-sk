<template>
    <div>
        ...
        <div class="container">
            <Link :href="route('/')" title="mweb.sk" class="navbar-brand px-2"><h1 class="text-light">mWeb.sk</h1></Link>
        ...
        <div class="container container-main ">
            <div class="row">
                ...
                <main class="col-9 pt-4">
                    ...
                    <div v-if="$page.props.flash.notice" class="alert alert-primary d-flex align-items-center" role="alert">
                        <div>
