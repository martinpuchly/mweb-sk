                ...
                <tr v-for="page in pages" :key="page.id" :class="!!page.deleted_at ? 'table-danger' : ''">
                    ...
                    <td>
                        <div v-if="!page.deleted_at">
                            ...
                            <Link :href="route('admin.pages.delete', page)" method="delete" title="vymazať" class="px-2" onclick="if(!confirm('Skutočne chcete stránku vymazať?')) return false;">
                        ...
                        <div v-else>
                            <Link :href="route('admin.pages.restore', page)" method="patch" title="obnoviť" class="px-2">
                            ...
                            <Link :href="route('admin.pages.destroy', page)" method="delete" title="permanentne vymazať" class="px-2" onclick="if(!confirm('Skutočne chcete stránku permanentne vymazať?')) return false;">
